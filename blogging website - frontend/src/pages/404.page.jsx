...
const PageNotFound = () => {
    return(
        <section className="h-cover relative p-10 flex flex-col items-center gap-20 text-center">
            ...
            <p className="text-dark-grey text-xl leading-7 -mt-8">The page you are looking for does not exist. Go back to the <Link to="/" className="text-black underline"> Home page </Link></p>
